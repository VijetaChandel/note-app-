...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (success) {
            navigate(localStorage.getItem('defaultView') || '/dashboard');
        } else {
    ...
    return (
        <div className="notepad-layout">
            ...
            <div className="sticky-chip chip-tl">meeting notes →</div>
            <div className="sticky-chip chip-tr">☑ buy groceries</div>
            <div className="sticky-chip chip-bl">ideas for Q2...</div>
            ...
            <div className="notepad-card">
                ...
                <p className="nc-subtext">Login to access your notes</p>

                <div className="pills-container">
                    <span className="feature-pill"><span className="pill-dot"></span> 120 notes</span>
                    <span className="feature-pill"><span className="pill-dot"></span> 8 notebooks</span>
                    <span className="feature-pill"><span className="pill-dot"></span> synced</span>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        <div className="password-header">
                            ...
                            <Link to="/forgot-password" className="forgot-link">forgot it? →</Link>
                        </div>
                ...
                <div className="register-footer">
                    Need an account? 
                    <Link to="/register" className="register-link">Start a fresh page</Link>
                </div>
            </div>
        </div>
    );
